...
const ComparisonBox: React.FC<ComparisonBoxProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-5">
      {/* Bad Example */}
      <div className="card bg-red-50 p-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      {/* Good Example */}
      <div className="card bg-green-50 p-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
