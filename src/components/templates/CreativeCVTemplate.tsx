    ...
    <div className="bg-gradient-to-br from-purple-50 to-blue-50 text-gray-800 p-8 rounded-lg">
      <div className="flex flex-col md:flex-row gap-8">
        <div className="md:w-2/5">
          <div className="bg-gradient-to-br from-purple-500 to-blue-500 text-white p-8 rounded-lg shadow-lg mb-6">
            ...
            <p className="text-sm leading-relaxed mb-4">
              Passionate creative professional with a unique vision and approach
              to design. I blend storytelling with visual elements to create
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div className="space-y-2 mb-4">
              <p>
                <span className="font-medium">Email:</span> alex.lee@example.com
              </p>
              <p>
                <span className="font-medium">Phone:</span> (456) 789-0123
              </p>
              <p>
                <span className="font-medium">Website:</span> alexleedesign.com
              </p>
              <p>
            ...
            <h2 className="font-bold text-xl mb-3 mt-6 text-purple-600">
              SKILLS
            </h2>
        ...
        <div className="md:w-3/5">
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            <h2 className="font-bold text-xl mb-3 text-purple-600">
              EXPERIENCE
            </h2>
            <div className="mb-5">
              ...
              <p className="text-purple-500 mb-2">
                Pulse Creative Studios, Los Angeles
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Lead a team of 8 designers creating motion graphics for major
                  brands
                </li>
                <li>
                  Developed brand identities for 12+ clients, increasing their
                  market recognition
                </li>
                <li>
                  Created award-winning animations for streaming platform
                  promotions
                </li>
            ...
            <div className="mb-5">
              ...
              <p className="text-purple-500 mb-2">
                Digital Waves Agency, San Francisco
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Created motion graphics and animations for tech industry
                  clients
                </li>
                <li>
                  Collaborated with marketing teams to develop visual
                  storytelling strategies
                </li>
                <li>
                  Designed interactive elements for web and mobile applications
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-purple-500 mb-2">
                Creative Solutions Inc., Portland
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Designed marketing materials and brand assets for diverse
                  clients
                </li>
                <li>
                  Created illustrations and graphics for print and digital media
                </li>
                <li>
                  Managed social media visual content for multiple accounts
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg">
                ...
                <p className="text-sm">
                  Motion design for international product launch, viewed by 2M+
                  people
                </p>
              </div>
              <div className="p-4 bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg">
                ...
                <p className="text-sm">
                  Complete visual identity refresh for leading entertainment
                  provider
                </p>
              </div>
              <div className="p-4 bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg">
                ...
                <p className="text-sm">
                  Stage graphics and animations for 3-day international event
                </p>
              </div>
              <div className="p-4 bg-gradient-to-br from-purple-100 to-blue-100 rounded-lg">
                <h3 className="font-bold">Mobile App Introduction</h3>
                <p className="text-sm">
                  Explainer animation for fintech startup, increasing conversion
                  by 35%
                </p>
              </div>
            </div>
